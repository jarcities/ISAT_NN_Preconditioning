...
def KmeansDataset(data1,n1,K1,K2,idim,device): # generate the training and testing datasets from numpy data
    ...
    Y = 10.0*data1[:n1,idim:] # training output (from data.csv)
    ...
    X2 = d[:,1:idim+1]
    Y2 = 10.0*d[:,idim+1:] # extract the cluster-arranged inputs and outputs
...
def main():
    ...
    parser.add_argument('--epochs', type=int, default=2000, metavar='N', #6000
    ...
    idim = 164 # dimension of the input/output

    nKmeans = 400 # number of samples in each K-Means cluster
