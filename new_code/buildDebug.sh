...
rm *.mod
rm main.exe
icpx -O0 -g -L$CONDA_PREFIX/lib -I$CONDA_PREFIX/include -I/usr/include/eigen3 -c reactor.cpp -std=c++17
ifx -O0 -g -L$CONDA_PREFIX/lib -I$CONDA_PREFIX/include -I/usr/include/eigen3 \
